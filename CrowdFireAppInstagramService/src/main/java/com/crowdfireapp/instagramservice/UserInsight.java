...
public class UserInsight {
	...
	private ResponseObject processFurther(InstagramApiClient instagramApi, String userName) {
		System.out.println("Getting the followers and its activity");
		List<UserActivity> followersActivityList = instagramApi.getFollowersActivity(userName);
		...
		ResponseObject responseObject = UserActivityHelper.getBestTimeToPost(followersActivityList);
		System.out.println("=========================================================");
